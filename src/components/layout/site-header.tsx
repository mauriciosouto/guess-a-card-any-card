        ...
        >
          {mainModes.map(({ href, label }) => (
            <Link
              ...
              href={href}
              className={cn(
                "font-display relative px-2 py-2 text-[0.7rem] font-semibold uppercase tracking-[0.14em] text-[var(--parchment-dim)] transition-colors duration-300 sm:px-3 sm:text-xs",
